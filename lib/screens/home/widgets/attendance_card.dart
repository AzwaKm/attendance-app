...
class AttendanceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final (cardColor, iconColor, iconData, statusText) = _getCardStyle(hasChecedkIn, hasCheckedOut);
  ...
  (Color, Color, IconData, String) _getCardStyle(bool hasChecedkIn, bool hasCheckedOut) {
    if (!hasChecedkIn) {
